...
def account():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            ...
            old_picture_full_path = os.path.join(current_app.root_path, 'static/profile_pics', current_user.image_file)
            if os.path.exists(old_picture_full_path) and current_user.image_file != 'default.jpg':
